...
do
    ...
    do
        ...
        Library.Watermark = function(Self, Params)
            local Watermark = {}
            local PrefixText = tostring((Params and Params.Name) or "ctr")
        ...
        Library.ESPPreview = function(Self, Params)
            ...
            do
                ...
                Items["ESPBox"] = Library:Create("Frame", {
                    Name = "\0",
                    Parent = Items["Background"].Instance,
                    BackgroundTransparency = 1,
                ...
                local CornerSegments = {
                    ...
                    { Position = UDim2.new(0, 0, 0.8, 0), Size = UDim2.new(0, 1, 0.2, 0) },
                    { Position = UDim2.new(0, 0, 1, -1), Size = UDim2.new(0.25, 0, 0, 1) },
                    { Position = UDim2.new(0.75, 0, 0, 0), Size = UDim2.new(0.25, 0, 0, 1) },
                    { Position = UDim2.new(1, -1, 0, 0), Size = UDim2.new(0, 1, 0.2, 0) },
                    { Position = UDim2.new(1, -1, 0.8, 0), Size = UDim2.new(0, 1, 0.2, 0) },
                    { Position = UDim2.new(0.75, 0, 1, -1), Size = UDim2.new(0.25, 0, 0, 1) }
                }
            ...
            function Preview:AddObject(Object)
                ...
                elseif Object:IsA("BoxHandleAdornment") or Object:IsA("CylinderHandleAdornment") or Object:IsA("Highlight") then
                    RenderObjects[Object] = Clone
                end
            ...
            local function BindAdornment(Object, Clone, Viewmodel)
                if not (Object:IsA("BoxHandleAdornment") or Object:IsA("CylinderHandleAdornment") or Object:IsA("Highlight")) then
                    return
                end

                local Adornee = Object.Adornee
                if Adornee and RenderObjects[Adornee] then
                    Clone.Adornee = RenderObjects[Adornee]
                elseif not Adornee and Object.Parent and RenderObjects[Object.Parent] then
                    Clone.Adornee = RenderObjects[Object.Parent]
                elseif Object:IsA("Highlight") and (Adornee == PreviewModel or (not Adornee and Object.Parent == PreviewModel)) then
                    Clone.Adornee = Viewmodel
                end
            end
            ...
            function Preview:BuildFromModel(Model)
                ...
                for Original, Clone in pairs(RenderObjects) do
                    if Clone.Parent == Viewmodel then
                        BindAdornment(Original, Clone, Viewmodel)
                    end
                end
                ...
                table.insert(Connections, Model.DescendantAdded:Connect(function(Object)
                    ...
                    if Clone then
                        Clone.Parent = Viewmodel
                        BindAdornment(Object, Clone, Viewmodel)
                    end
                end))
        ...
        Library.SpotifyPlayer = function(Self)
            ...
            function Spotify:Refresh()
                ...
                if Token == "" and TokenConfig.RefreshToken == "" then
                    SetDisplay(nil, "Add a token or refresh config to ctr/token.txt")
                    return false
                end
                ...
                if not ValidateToken() then
                    SetDisplay(nil, "Invalid token in ctr/token.txt")
                    return false
                end
